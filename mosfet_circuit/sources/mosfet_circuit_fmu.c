...
# define RT_MDL_TYPE      RT_MODEL_mosfet_circuit_T
#endif
#define QUOTE1(name) #name
#define QUOTE(name) QUOTE1(name)    /* need to expand name    */
#ifndef FMI2_FUNCTION_PREFIX
#define FMI2_FUNCTION_PREFIX mosfet_circuit_
#endif
/*==========*
 * Includes *
 *==========*/
...
#include "mosfet_circuit_private.h"
...
void fmu_LogOutput() {
    FMUModelData *modelData = (FMUModelData *)_instance;
    modelData->rOutput[0] = *(modelData->rList[1]);
}
void fmu_RestoreOutput() {
    FMUModelData *modelData = (FMUModelData *)_instance;
    *(modelData->rList[1]) = modelData->rOutput[0];
}
...
fmi2Component fmi2Instantiate(fmi2String instanceName, fmi2Type fmuType, fmi2String fmuGUID,
    ...
    if (!functions->logger) {
        ...
        return NULL;
    } else if (strcmp(fmuGUID, "{6461761f-6d19-3750-cdd6-39a05008261f}")) {
        functions->logger(functions->componentEnvironment, instanceName, fmi2Error, "error",
                "fmi2Instantiate: Wrong GUID %s. Expected %s.", fmuGUID, "{6461761f-6d19-3750-cdd6-39a05008261f}");
        return NULL;
    }
    ...
    modelData->rList = (real_T**)calloc(3, sizeof(real_T*));
    if (!modelData->rList) {
        functions->logger(functions->componentEnvironment, instanceName, fmi2Error, "error",
                "fmi2Instantiate: Memory allocation error.");
        return NULL;
    ...
    modelData->rList[0] = &(mosfet_circuit_U.In1);
    modelData->rList[1] = &(mosfet_circuit_Y.Vout);
