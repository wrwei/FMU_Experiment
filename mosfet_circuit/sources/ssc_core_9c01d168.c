...
PmSparsityPattern*mc__srK5LmyWw42ZyPnbOWDWJ,PmRealVector*
mc_VlnhKi82gfCLgumIqeduOq,PmRealVector*b,NeSystemInputSizes sizes);
McIntFunction*ssc_core_VhIyDecAI9K5_qrodBaSYI(NeSystemInputSizes sizes);
#include "pm_std.h"
...
mc__lg6aMpGv4SRYTkiYXDYMa,pm_FbYb_iLqY2hwZTVlVaiqJY);neu_destroy_system_input(
mc_k0CXwzVaibdnZiGUCx6PMZ->mc_ko6_hiERTRldgDROOJBQCH->
...
neu_create_system_input(neu_get_empty_system_input_sizes(),
...
ssc_core_koOkeH4t5thP_epkrR3i6F;mc_k0CXwzVaibdnZiGUCx6PMZ->
mc_VYGWBho6N1K_eyHOMGjDiW= &ssc_core_klcVFSVHywSG_5slnMWIaN;return
