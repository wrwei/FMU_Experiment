...
ex_F4J173IGY_hgXaf_WD6AOj(real_T*fi,const real_T*basis,const size_t bin,const
real_T*fx,const size_t n,const size_t ex_F_tm5fod4xxuguhS49BSQm,const real_T*
work1,const size_t*work2);static void ex_kYk7SswBvLtHbmZRWvRMEh(real_T*x,
real_T*fx,const real_T*xs,const real_T*fs,const size_t n);void
tlu2_1d_akima_nearest_process(real_T*x,real_T*fx,const real_T*xs,const real_T*
fs,const size_t*n){ex_kYk7SswBvLtHbmZRWvRMEh(x,fx,xs,fs,*n);}void
...
const*)in)[2];real_T*x=(real_T*)((void**)out)[0];real_T*fx=(real_T*)((void**)
out)[1];tlu2_1d_akima_nearest_process(x,fx,xs,fs,n);}void
tlu2_1d_akima_linear_process(real_T*x,real_T*fx,const real_T*xs,const real_T*
fs,const size_t*n){ex_kYk7SswBvLtHbmZRWvRMEh(x,fx,xs,fs,*n);}void
tlu2_1d_akima_linear_process_custom_function_(void*out,const void*in){const
real_T*xs=(const real_T*)((const void*const*)in)[0];const real_T*fs=(const
real_T*)((const void*const*)in)[1];const size_t*n=(const size_t*)((const void*
const*)in)[2];real_T*x=(real_T*)((void**)out)[0];real_T*fx=(real_T*)((void**)
out)[1];tlu2_1d_akima_linear_process(x,fx,xs,fs,n);}static void
ex_kYk7SswBvLtHbmZRWvRMEh(real_T*x,real_T*fx,const real_T*xs,const real_T*fs,
const size_t n){const size_t ex_F3nVSXkoDK8VeeL5OmY0_B=1;const real_T*
ex_VToqGBrino_cYuTsjsb5G7[1];real_T*ex_VsAv95vpmFp3i1E54_unM9=pmf_malloc(n*
...
ex_VToqGBrino_cYuTsjsb5G7[0]=x;memcpy(x,xs,n*sizeof(real_T));memcpy(
ex_VsAv95vpmFp3i1E54_unM9,fs,n*sizeof(real_T));ex_FtfBZE2kLGxyWamCvlRfeQ(x,
ex_VsAv95vpmFp3i1E54_unM9,n);ex_FJUlENJSohGphDc_Rf36LU(
ex_F3nVSXkoDK8VeeL5OmY0_B,&n,&ex_FzsezTJVFaKAhHt_a3UeWF,&
...
);ex_kEWp_Qwr9TpuV5h0iCW4f_(ex_F3nVSXkoDK8VeeL5OmY0_B,&n,
ex_VToqGBrino_cYuTsjsb5G7,ex_VsAv95vpmFp3i1E54_unM9,&ex_V1PpSt9JShK3bL1Bw6asF1
[0],&ex_VVfVnPxpzepMZXSq9ZSsjY[0],fx);pmf_free(ex_VsAv95vpmFp3i1E54_unM9);
pmf_free(ex_V1PpSt9JShK3bL1Bw6asF1);pmf_free(ex_VVfVnPxpzepMZXSq9ZSsjY);}void
tlu2_1d_akima_nearest_value(real_T*fi,const real_T*basis,const size_t*bin,
const real_T*fx,const size_t*n,const real_T*work1,const size_t*work2,const
size_t*numels){size_t ex__wN5g_p_uwdVVLfRtx9szc;for(ex__wN5g_p_uwdVVLfRtx9szc=
0;ex__wN5g_p_uwdVVLfRtx9szc<*numels;ex__wN5g_p_uwdVVLfRtx9szc++){
ex_F4J173IGY_hgXaf_WD6AOj(fi+ex__wN5g_p_uwdVVLfRtx9szc,basis+4*
ex__wN5g_p_uwdVVLfRtx9szc,*(bin+ex__wN5g_p_uwdVVLfRtx9szc),fx,*n,0,work1,work2
);}}void tlu2_1d_akima_nearest_value_custom_function_(void*out,const void*in){
const real_T*basis=(const real_T*)((const void*const*)in)[0];const size_t*bin=
(const size_t*)((const void*const*)in)[1];const real_T*fx=(const real_T*)((
const void*const*)in)[2];const size_t*n=(const size_t*)((const void*const*)in)
[3];const real_T*work1=(const real_T*)((const void*const*)in)[4];const size_t*
work2=(const size_t*)((const void*const*)in)[5];const size_t*numels=(const
size_t*)((const void*const*)in)[6];real_T*fi=(real_T*)out;
tlu2_1d_akima_nearest_value(fi,basis,bin,fx,n,work1,work2,numels);}void
tlu2_1d_akima_linear_value(real_T*fi,const real_T*basis,const size_t*bin,const
real_T*fx,const size_t*n,const real_T*work1,const size_t*work2,const size_t*
...
ex_F4J173IGY_hgXaf_WD6AOj(fi+ex__wN5g_p_uwdVVLfRtx9szc,basis+4*
ex__wN5g_p_uwdVVLfRtx9szc,*(bin+ex__wN5g_p_uwdVVLfRtx9szc),fx,*n,1,work1,work2
);}}void tlu2_1d_akima_linear_value_custom_function_(void*out,const void*in){
const real_T*basis=(const real_T*)((const void*const*)in)[0];const size_t*bin=
(const size_t*)((const void*const*)in)[1];const real_T*fx=(const real_T*)((
const void*const*)in)[2];const size_t*n=(const size_t*)((const void*const*)in)
[3];const real_T*work1=(const real_T*)((const void*const*)in)[4];const size_t*
work2=(const size_t*)((const void*const*)in)[5];const size_t*numels=(const
size_t*)((const void*const*)in)[6];real_T*fi=(real_T*)out;
tlu2_1d_akima_linear_value(fi,basis,bin,fx,n,work1,work2,numels);}static void
ex_F4J173IGY_hgXaf_WD6AOj(real_T*fi,const real_T*ex_Vl61InPOzylYgiebES6ELs,
const size_t bin,const real_T*ex_VorZCi5_B5tOa9oe3bnRf5,const size_t n,const
size_t ex_F_tm5fod4xxuguhS49BSQm,const real_T*work1,const size_t*work2){const
size_t ex_F3nVSXkoDK8VeeL5OmY0_B=1;const real_T**ex_kB4aOAnByNCbf5JZPcoQy5=0;
const real_T**ex_FNyrrBDfkJhIjyNSa2fMBz=0;const size_t
ex__NJXN1LXJ3dhZPDo3_p2LH=1;real_T*basis[1];size_t ex__I2IEgdElv80cD1Kv0uRpM[1
];size_t*ex_Vic4f_t1_8lMdPxTHOuua8[1];real_T*ex_V1PpSt9JShK3bL1Bw6asF1;size_t*
ex_VVfVnPxpzepMZXSq9ZSsjY;basis[0]=ex_VQMmQUcKA3_3ei3Owj7WVV(
ex_Vl61InPOzylYgiebES6ELs);ex__I2IEgdElv80cD1Kv0uRpM[0]=bin;
ex_Vic4f_t1_8lMdPxTHOuua8[0]=ex__I2IEgdElv80cD1Kv0uRpM;
ex_V1PpSt9JShK3bL1Bw6asF1=ex_VQMmQUcKA3_3ei3Owj7WVV(work1);
ex_VVfVnPxpzepMZXSq9ZSsjY=ex__ge8CPdYTqKVfmxfN0MdXT(work2);
ex__I__tR3HVGtUdmAFtUcU_G(ex_F3nVSXkoDK8VeeL5OmY0_B,&n,
ex_kB4aOAnByNCbf5JZPcoQy5,ex_F_tm5fod4xxuguhS49BSQm+1,
ex_VQMmQUcKA3_3ei3Owj7WVV(ex_VorZCi5_B5tOa9oe3bnRf5),basis,&
