 ...
 */
/* mosfet_circuit_836bb176_1_ds.c - body for module mosfet_circuit_836bb176_1_ds */

#include "ne_ds.h"
#include "mosfet_circuit_836bb176_1_ds_obs_all.h"
#include "mosfet_circuit_836bb176_1_ds_obs_act.h"
...
static NeObservableData s_observable_data[27] = { {
    "Controlled_Voltage_Source.i", "mosfet_circuit/Controlled Voltage Source", {
      { 1, 1 } }, "A", 1.0, "A", NE_NOMINAL_SOURCE_MODEL, NE_INIT_MODE_NONE,
    FALSE, FALSE, NE_FREQTIME_TYPE_TIME, TRUE, TRUE, "i", }, {
    "Controlled_Voltage_Source.n.v", "mosfet_circuit/Controlled Voltage Source",
    { { 1, 1 } }, "V", 1.0, "V", NE_NOMINAL_SOURCE_MODEL, NE_INIT_MODE_NONE,
    TRUE, FALSE, NE_FREQTIME_TYPE_TIME, TRUE, TRUE, "Voltage", }, {
    "Controlled_Voltage_Source.p.v", "mosfet_circuit/Controlled Voltage Source",
    { { 1, 1 } }, "V", 1.0, "V", NE_NOMINAL_SOURCE_MODEL, NE_INIT_MODE_NONE,
    FALSE, FALSE, NE_FREQTIME_TYPE_TIME, TRUE, TRUE, "Voltage", }, {
    "Controlled_Voltage_Source.v", "mosfet_circuit/Controlled Voltage Source", {
      { 1, 1 } }, "V", 1.0, "V", NE_NOMINAL_SOURCE_MODEL, NE_INIT_MODE_NONE,
    FALSE, FALSE, NE_FREQTIME_TYPE_TIME, TRUE, TRUE, "v", }, {
    "Controlled_Voltage_Source.vT", "mosfet_circuit/Controlled Voltage Source",
      { { 1, 1 } }, "V", 1.0, "V", NE_NOMINAL_SOURCE_MODEL, NE_INIT_MODE_NONE,
    FALSE, FALSE, NE_FREQTIME_TYPE_TIME, TRUE, TRUE, "vT", }, { "GND2.V.v",
    "mosfet_circuit/GND2", { { 1, 1 } }, "V", 1.0, "V", NE_NOMINAL_SOURCE_MODEL,
    NE_INIT_MODE_NONE, TRUE, FALSE, NE_FREQTIME_TYPE_TIME, TRUE, TRUE, "Voltage",
  }, { "R1.faultExtTrigger", "mosfet_circuit/R1", { { 1, 1 } }, "1", 1.0, "1",
    NE_NOMINAL_SOURCE_DERIVED, NE_INIT_MODE_NONE, TRUE, FALSE,
    NE_FREQTIME_TYPE_TIME, FALSE, TRUE, "External fault trigger", }, { "R1.n.v",
    "mosfet_circuit/R1", { { 1, 1 } }, "V", 1.0, "V", NE_NOMINAL_SOURCE_MODEL,
    NE_INIT_MODE_NONE, FALSE, FALSE, NE_FREQTIME_TYPE_TIME, TRUE, TRUE,
    "Voltage", }, { "R1.p.v", "mosfet_circuit/R1", { { 1, 1 } }, "V", 1.0, "V",
    NE_NOMINAL_SOURCE_MODEL, NE_INIT_MODE_NONE, FALSE, FALSE,
    NE_FREQTIME_TYPE_TIME, TRUE, TRUE, "Voltage", }, { "R1.Resistor.i",
    "mosfet_circuit/R1", { { 1, 1 } }, "A", 1.0, "A", NE_NOMINAL_SOURCE_MODEL,
    NE_INIT_MODE_NONE, FALSE, FALSE, NE_FREQTIME_TYPE_TIME, TRUE, TRUE,
    "Current", }, { "R1.Resistor.n.v", "mosfet_circuit/R1", { { 1, 1 } }, "V",
    1.0, "V", NE_NOMINAL_SOURCE_MODEL, NE_INIT_MODE_NONE, FALSE, FALSE,
    NE_FREQTIME_TYPE_TIME, TRUE, TRUE, "Voltage", }, { "R1.Resistor.p.v",
    "mosfet_circuit/R1", { { 1, 1 } }, "V", 1.0, "V", NE_NOMINAL_SOURCE_MODEL,
    NE_INIT_MODE_NONE, FALSE, FALSE, NE_FREQTIME_TYPE_TIME, TRUE, TRUE,
    "Voltage", }, { "R1.Resistor.v", "mosfet_circuit/R1", { { 1, 1 } }, "V", 1.0,
    "V", NE_NOMINAL_SOURCE_MODEL, NE_INIT_MODE_NONE, FALSE, FALSE,
    NE_FREQTIME_TYPE_TIME, TRUE, TRUE, "Voltage", }, {
    "R1.Resistor.power_dissipated", "mosfet_circuit/R1", { { 1, 1 } }, "A^2*Ohm",
    1.0, "A^2*Ohm", NE_NOMINAL_SOURCE_NONE, NE_INIT_MODE_NONE, FALSE, FALSE,
    NE_FREQTIME_TYPE_TIME, TRUE, FALSE, "power_dissipated", }, {
    "R2.faultExtTrigger", "mosfet_circuit/R2", { { 1, 1 } }, "1", 1.0, "1",
    NE_NOMINAL_SOURCE_DERIVED, NE_INIT_MODE_NONE, TRUE, FALSE,
    NE_FREQTIME_TYPE_TIME, FALSE, TRUE, "External fault trigger", }, { "R2.n.v",
    "mosfet_circuit/R2", { { 1, 1 } }, "V", 1.0, "V", NE_NOMINAL_SOURCE_MODEL,
    NE_INIT_MODE_NONE, TRUE, FALSE, NE_FREQTIME_TYPE_TIME, TRUE, TRUE, "Voltage",
  }, { "R2.p.v", "mosfet_circuit/R2", { { 1, 1 } }, "V", 1.0, "V",
    NE_NOMINAL_SOURCE_MODEL, NE_INIT_MODE_NONE, FALSE, FALSE,
    NE_FREQTIME_TYPE_TIME, TRUE, TRUE, "Voltage", }, { "R2.Resistor.i",
    "mosfet_circuit/R2", { { 1, 1 } }, "A", 1.0, "A", NE_NOMINAL_SOURCE_MODEL,
    NE_INIT_MODE_NONE, FALSE, FALSE, NE_FREQTIME_TYPE_TIME, TRUE, TRUE,
    "Current", }, { "R2.Resistor.n.v", "mosfet_circuit/R2", { { 1, 1 } }, "V",
    1.0, "V", NE_NOMINAL_SOURCE_MODEL, NE_INIT_MODE_NONE, TRUE, FALSE,
    NE_FREQTIME_TYPE_TIME, TRUE, TRUE, "Voltage", }, { "R2.Resistor.p.v",
    "mosfet_circuit/R2", { { 1, 1 } }, "V", 1.0, "V", NE_NOMINAL_SOURCE_MODEL,
    NE_INIT_MODE_NONE, FALSE, FALSE, NE_FREQTIME_TYPE_TIME, TRUE, TRUE,
    "Voltage", }, { "R2.Resistor.v", "mosfet_circuit/R2", { { 1, 1 } }, "V", 1.0,
    "V", NE_NOMINAL_SOURCE_MODEL, NE_INIT_MODE_NONE, FALSE, FALSE,
    NE_FREQTIME_TYPE_TIME, TRUE, TRUE, "Voltage", }, {
    "R2.Resistor.power_dissipated", "mosfet_circuit/R2", { { 1, 1 } }, "A^2*Ohm",
    1.0, "A^2*Ohm", NE_NOMINAL_SOURCE_NONE, NE_INIT_MODE_NONE, FALSE, FALSE,
    NE_FREQTIME_TYPE_TIME, TRUE, FALSE, "power_dissipated", }, {
    "Simulink_PS_Converter_output0", "mosfet_circuit/Simulink-PS\nConverter", {
    ...
    "mosfet_circuit/Voltage Sensor", { { 1, 1 } }, "V", 1.0, "V",
    NE_NOMINAL_SOURCE_MODEL, NE_INIT_MODE_NONE, FALSE, FALSE,
...
static NeAssertData s_assert_data[4] = { { "mosfet_circuit/R1", 1U, 0U,
    "R1.Resistor.power_dissipated",
    "D:/MATLAB/R2023a/toolbox/physmod/simscape/library/m/+foundation/+electrical/+elements/resistor.ssc",
    FALSE,
    ...
    "mosfet_circuit/R1", 1U, 1U, "R1.Resistor.power_dissipated",
    "D:/MATLAB/R2023a/toolbox/physmod/simscape/library/m/+foundation/+electrical/+elements/resistor.ssc",
    FALSE,
    ...
    "mosfet_circuit/R2", 1U, 2U, "R2.Resistor.power_dissipated",
    "D:/MATLAB/R2023a/toolbox/physmod/simscape/library/m/+foundation/+electrical/+elements/resistor.ssc",
    FALSE,
    "In power, the exponent must be positive when the base is equal to zero.",
    "physmod:common:mf:expr:analyze:RequireExponentPositive", }, {
    "mosfet_circuit/R2", 1U, 3U, "R2.Resistor.power_dissipated",
    "D:/MATLAB/R2023a/toolbox/physmod/simscape/library/m/+foundation/+electrical/+elements/resistor.ssc",
    FALSE,
    "In power, the base must be nonnegative when the exponent is not an integer.",
    "physmod:common:mf:expr:analyze:RequireBaseNonnegative", } };

static NeRange s_assert_range[4] = { {
    "D:/MATLAB/R2023a/toolbox/physmod/simscape/library/m/+foundation/+electrical/+elements/resistor.ssc",
...
NeDynamicSystem *mosfet_circuit_836bb176_1_dae_ds(PmAllocator *allocator)
{
  NeDynamicSystem *ds;
  _NeDynamicSystem *_ds;
  ...
  ds->mNumRealCache = 0;
  ds->mNumIntCache = 0;
  ds->mNumObservables = 27;
  ds->mNumObservableElements = 25;
  ds->mNumZcs = 0;
  ds->mNumAsserts = 4;
  ds->mNumAssertRanges = 4;
  ...
  input_info[0].mIdentifier = "Simulink_PS_Converter_output0";
  ...
  input_info[0].mName = "Simulink_PS_Converter_output0";
  input_info[0].mUnit = "1";
  ds->mIo[SSC_INPUT_IO_TYPE] = input_info;
  ds->mNumIo[SSC_OUTPUT_IO_TYPE] = 1;
  output_info[0].mIdentifier = "Voltage_Sensor_V0";
  ...
  output_info[0].mName = "Voltage_Sensor_V0";
  ...
  ds->mMethods[NE_DS_METHOD_LOG] = mosfet_circuit_836bb176_1_ds_log;
  ...
  ds->mMethods[NE_DS_METHOD_OBS_ACT] = mosfet_circuit_836bb176_1_ds_obs_act;
  ds->mMakeOutput[NE_DS_METHOD_OBS_ACT] = ds_output_obs_act;
  ds->mMethods[NE_DS_METHOD_OBS_ALL] = mosfet_circuit_836bb176_1_ds_obs_all;
                     ...
                     NeDsMethodOutput *t3)
{
  ...
  U_idx_0 = t2->mU.mX[0];
  out = t3->mY;
  out.mX[0] = U_idx_0 * 0.16666666666666666;
  (void)sys;
  (void)t3;
  return 0;
}
