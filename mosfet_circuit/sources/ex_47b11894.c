...
ex_FzXlwsFdzbGOh5RDZi0NNm(real_T*fi,const real_T*basis1,const size_t bin1,
const real_T*basis2,const size_t bin2,const real_T*fx,const size_t n1,const
size_t n2,const size_t ex_F_tm5fod4xxuguhS49BSQm,const real_T*work1,const
size_t*work2);static void ex_FokJD1b8z0WJX9TTsQfvSP(real_T*x1,real_T*x2,real_T
*fx,const real_T*x1s,const real_T*x2s,const real_T*fs,const size_t n1,const
size_t n2);void tlu2_2d_akima_nearest_process(real_T*x1,real_T*x2,real_T*fx1,
const real_T*x1s,const real_T*x2s,const real_T*fs,const size_t*n1,const size_t
*n2){ex_FokJD1b8z0WJX9TTsQfvSP(x1,x2,fx1,x1s,x2s,fs,*n1,*n2);}void
...
real_T*fx1,const size_t*n1,const size_t*n2,const real_T*work1,const size_t*
...
ex__wN5g_p_uwdVVLfRtx9szc++){ex_FzXlwsFdzbGOh5RDZi0NNm(fi+
...
ex__wN5g_p_uwdVVLfRtx9szc),fx1,*n1,*n2,0,work1,work2);}}void
...
in)[3];const real_T*fx=(const real_T*)((const void*const*)in)[4];const size_t*
n1=(const size_t*)((const void*const*)in)[5];const size_t*n2=(const size_t*)((
const void*const*)in)[6];const real_T*work1=(const real_T*)((const void*const*
)in)[7];const size_t*work2=(const size_t*)((const void*const*)in)[8];const
size_t*numels=(const size_t*)((const void*const*)in)[9];real_T*fi=(real_T*)out
;tlu2_2d_akima_nearest_value(fi,basis1,bin1,basis2,bin2,fx,n1,n2,work1,work2,
numels);}void tlu2_2d_akima_linear_value(real_T*fi,const real_T*basis1,const
size_t*bin1,const real_T*basis2,const size_t*bin2,const real_T*fx1,const size_t
*n1,const size_t*n2,const real_T*work1,const size_t*work2,const size_t*numels)
{size_t ex__wN5g_p_uwdVVLfRtx9szc;for(ex__wN5g_p_uwdVVLfRtx9szc=0;
ex__wN5g_p_uwdVVLfRtx9szc<*numels;ex__wN5g_p_uwdVVLfRtx9szc++){
ex_FzXlwsFdzbGOh5RDZi0NNm(fi+ex__wN5g_p_uwdVVLfRtx9szc,basis1+4*
ex__wN5g_p_uwdVVLfRtx9szc,*(bin1+ex__wN5g_p_uwdVVLfRtx9szc),basis2+4*
ex__wN5g_p_uwdVVLfRtx9szc,*(bin2+ex__wN5g_p_uwdVVLfRtx9szc),fx1,*n1,*n2,1,
work1,work2);}}void tlu2_2d_akima_linear_value_custom_function_(void*out,const
void*in){const real_T*basis1=(const real_T*)((const void*const*)in)[0];const
size_t*bin1=(const size_t*)((const void*const*)in)[1];const real_T*basis2=(
const real_T*)((const void*const*)in)[2];const size_t*bin2=(const size_t*)((
const void*const*)in)[3];const real_T*fx=(const real_T*)((const void*const*)in
)[4];const size_t*n1=(const size_t*)((const void*const*)in)[5];const size_t*n2
=(const size_t*)((const void*const*)in)[6];const real_T*work1=(const real_T*)(
(const void*const*)in)[7];const size_t*work2=(const size_t*)((const void*const
*)in)[8];const size_t*numels=(const size_t*)((const void*const*)in)[9];real_T*
fi=(real_T*)out;tlu2_2d_akima_linear_value(fi,basis1,bin1,basis2,bin2,fx,n1,n2
,work1,work2,numels);}static void ex_FzXlwsFdzbGOh5RDZi0NNm(real_T*fi,const
real_T*ex_Vl61InPOzylYgiebES6ELs,const size_t bin1,const real_T*
...
=n1*n2;const size_t ex_F3nVSXkoDK8VeeL5OmY0_B=2;size_t
ex__jP7F4Fk5ExlWmUH2CnO0p[2];const real_T**ex_kB4aOAnByNCbf5JZPcoQy5=0;const
real_T**ex_FNyrrBDfkJhIjyNSa2fMBz=0;const size_t ex__NJXN1LXJ3dhZPDo3_p2LH=1;
real_T*basis[2];size_t ex__I2IEgdElv80cD1Kv0uRpM[1];size_t
...
ex_VQMmQUcKA3_3ei3Owj7WVV(ex_kB9XB9hzwwW7Vu4shvxxya);ex__I2IEgdElv80cD1Kv0uRpM
