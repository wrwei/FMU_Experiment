...
ex_FcBoyAOGyQhIhHf_kb6OE_(real_T*fi,const real_T*basis1,const size_t bin1,
...
real_T*basis3,const size_t*bin3,const real_T*fx,const size_t*n1,const size_t*
n2,const size_t*n3,const real_T*work1,const size_t*work2,const size_t*numels){
...
ex_FcBoyAOGyQhIhHf_kb6OE_(fi+ex__wN5g_p_uwdVVLfRtx9szc,basis1+4*
...
ex__wN5g_p_uwdVVLfRtx9szc,*(bin3+ex__wN5g_p_uwdVVLfRtx9szc),fx,*n1,*n2,*n3,0,
work1,work2);}}void tlu2_3d_akima_nearest_value_custom_function_(void*out,
...
const void*const*)in)[8];const size_t*n3=(const size_t*)((const void*const*)in
)[9];const real_T*work1=(const real_T*)((const void*const*)in)[10];const size_t
*work2=(const size_t*)((const void*const*)in)[11];const size_t*numels=(const
size_t*)((const void*const*)in)[12];real_T*fi=(real_T*)out;
tlu2_3d_akima_nearest_value(fi,basis1,bin1,basis2,bin2,basis3,bin3,fx,n1,n2,n3
,work1,work2,numels);}void tlu2_3d_akima_linear_value(real_T*fi,const real_T*
basis1,const size_t*bin1,const real_T*basis2,const size_t*bin2,const real_T*
basis3,const size_t*bin3,const real_T*fx1,const size_t*n1,const size_t*n2,
const size_t*n3,const real_T*work1,const size_t*work2,const size_t*numels){
size_t ex__wN5g_p_uwdVVLfRtx9szc;for(ex__wN5g_p_uwdVVLfRtx9szc=0;
ex__wN5g_p_uwdVVLfRtx9szc<*numels;ex__wN5g_p_uwdVVLfRtx9szc++){
ex_FcBoyAOGyQhIhHf_kb6OE_(fi+ex__wN5g_p_uwdVVLfRtx9szc,basis1+4*
ex__wN5g_p_uwdVVLfRtx9szc,*(bin1+ex__wN5g_p_uwdVVLfRtx9szc),basis2+4*
ex__wN5g_p_uwdVVLfRtx9szc,*(bin2+ex__wN5g_p_uwdVVLfRtx9szc),basis3+4*
ex__wN5g_p_uwdVVLfRtx9szc,*(bin3+ex__wN5g_p_uwdVVLfRtx9szc),fx1,*n1,*n2,*n3,1,
work1,work2);}}void tlu2_3d_akima_linear_value_custom_function_(void*out,const
...
const void*const*)in)[3];const real_T*basis3=(const real_T*)((const void*const
*)in)[4];const size_t*bin3=(const size_t*)((const void*const*)in)[5];const
real_T*fx=(const real_T*)((const void*const*)in)[6];const size_t*n1=(const
size_t*)((const void*const*)in)[7];const size_t*n2=(const size_t*)((const void
*const*)in)[8];const size_t*n3=(const size_t*)((const void*const*)in)[9];const
real_T*work1=(const real_T*)((const void*const*)in)[10];const size_t*work2=(
const size_t*)((const void*const*)in)[11];const size_t*numels=(const size_t*)(
(const void*const*)in)[12];real_T*fi=(real_T*)out;tlu2_3d_akima_linear_value(
fi,basis1,bin1,basis2,bin2,basis3,bin3,fx,n1,n2,n3,work1,work2,numels);}static
void ex_FcBoyAOGyQhIhHf_kb6OE_(real_T*fi,const real_T*
ex_Vl61InPOzylYgiebES6ELs,const size_t bin1,const real_T*
ex_kB9XB9hzwwW7Vu4shvxxya,const size_t bin2,const real_T*
ex__laKwhSBF10XcXh2QbGZxl,const size_t bin3,const real_T*fx,const size_t n1,
const size_t n2,const size_t n3,const size_t ex_F_tm5fod4xxuguhS49BSQm,const
real_T*work1,const size_t*work2){const size_t n=n1*n2*n3;const size_t
...
size_t ex__NJXN1LXJ3dhZPDo3_p2LH=1;real_T*basis[3];size_t
...
ex__laKwhSBF10XcXh2QbGZxl);ex__I2IEgdElv80cD1Kv0uRpM[0]=bin1;
...
ex_Vic4f_t1_8lMdPxTHOuua8[2]=ex_VTU42MKlyy4vayjUvcNV_7;
