...
ex_kTwu6FGHauCWW1q7bqdYqX(real_T*fi,const real_T*basis1,const size_t bin1,
const real_T*basis2,const size_t bin2,const real_T*basis3,const size_t bin3,
const real_T*basis4,const size_t bin4,const real_T*fx,const size_t n1,const
size_t n2,const size_t n3,const size_t n4,const size_t
ex_F_tm5fod4xxuguhS49BSQm,const real_T*work1,const size_t*work2);static void
ex__s5fN6i6XodjdLeaZS47pR(real_T*x1,real_T*x2,real_T*x3,real_T*x4,real_T*fx,
const real_T*x1s,const real_T*x2s,const real_T*x3s,const real_T*x4s,const
...
n4){ex__s5fN6i6XodjdLeaZS47pR(x1,x2,x3,x4,fx1,x1s,x2s,x3s,x4s,fs,*n1,*n2,*n3,*
n4);}void tlu2_4d_akima_nearest_process_custom_function_(void*out,const void*
in){const real_T*x1s=(const real_T*)((const void*const*)in)[0];const real_T*
x2s=(const real_T*)((const void*const*)in)[1];const real_T*x3s=(const real_T*)
((const void*const*)in)[2];const real_T*x4s=(const real_T*)((const void*const*
)in)[3];const real_T*fs=(const real_T*)((const void*const*)in)[4];const size_t
*n1=(const size_t*)((const void*const*)in)[5];const size_t*n2=(const size_t*)(
(const void*const*)in)[6];const size_t*n3=(const size_t*)((const void*const*)
in)[7];const size_t*n4=(const size_t*)((const void*const*)in)[8];real_T*x1=(
real_T*)((void**)out)[0];real_T*x2=(real_T*)((void**)out)[1];real_T*x3=(real_T
*)((void**)out)[2];real_T*x4=(real_T*)((void**)out)[3];real_T*fx=(real_T*)((
void**)out)[4];tlu2_4d_akima_nearest_process(x1,x2,x3,x4,fx,x1s,x2s,x3s,x4s,fs
,n1,n2,n3,n4);}void tlu2_4d_akima_linear_process(real_T*x1,real_T*x2,real_T*x3
,real_T*x4,real_T*fx1,const real_T*x1s,const real_T*x2s,const real_T*x3s,const
real_T*x4s,const real_T*fs,const size_t*n1,const size_t*n2,const size_t*n3,
const size_t*n4){ex__s5fN6i6XodjdLeaZS47pR(x1,x2,x3,x4,fx1,x1s,x2s,x3s,x4s,fs,
*n1,*n2,*n3,*n4);}void tlu2_4d_akima_linear_process_custom_function_(void*out,
...
*fx=(real_T*)((void**)out)[4];tlu2_4d_akima_linear_process(x1,x2,x3,x4,fx,x1s,
x2s,x3s,x4s,fs,n1,n2,n3,n4);}static void ex__s5fN6i6XodjdLeaZS47pR(real_T*x1,
...
n2,const size_t n3,const size_t n4){const size_t ex_F3nVSXkoDK8VeeL5OmY0_B=4;
size_t ex__jP7F4Fk5ExlWmUH2CnO0p[4];const real_T*ex_VToqGBrino_cYuTsjsb5G7[4];
const size_t n=n1*n2*n3*n4;real_T*ex_VsAv95vpmFp3i1E54_unM9=pmf_malloc(n*
sizeof(real_T));size_t ex_FzsezTJVFaKAhHt_a3UeWF;size_t
ex_kdATsbeSp_x8_DV4Ry4QD0;size_t ex_FP2u25405gSWeDgzM8AO0G;real_T*
ex_V1PpSt9JShK3bL1Bw6asF1;size_t*ex_VVfVnPxpzepMZXSq9ZSsjY;real_T*
ex_VorZCi5_B5tOa9oe3bnRf5;ex__jP7F4Fk5ExlWmUH2CnO0p[0]=n1;
ex__jP7F4Fk5ExlWmUH2CnO0p[1]=n2;ex__jP7F4Fk5ExlWmUH2CnO0p[2]=n3;
ex__jP7F4Fk5ExlWmUH2CnO0p[3]=n4;ex_VToqGBrino_cYuTsjsb5G7[0]=x1;
ex_VToqGBrino_cYuTsjsb5G7[1]=x2;ex_VToqGBrino_cYuTsjsb5G7[2]=x3;
ex_VToqGBrino_cYuTsjsb5G7[3]=x4;memcpy(x1,x1s,n1*sizeof(real_T));memcpy(x2,x2s
,n2*sizeof(real_T));memcpy(x3,x3s,n3*sizeof(real_T));memcpy(x4,x4s,n4*sizeof(
real_T));memcpy(ex_VsAv95vpmFp3i1E54_unM9,fs,n*sizeof(real_T));
ex_F_6wSEEsvm_1cTAuvwDt9B(x1,x2,x3,x4,ex_VsAv95vpmFp3i1E54_unM9,n1,n2,n3,n4);
...
(ex_kdATsbeSp_x8_DV4Ry4QD0*sizeof(size_t));ex_VorZCi5_B5tOa9oe3bnRf5=
ex_VQMmQUcKA3_3ei3Owj7WVV(fx1);ex_kEWp_Qwr9TpuV5h0iCW4f_(
...
ex_VVfVnPxpzepMZXSq9ZSsjY[0],&ex_VorZCi5_B5tOa9oe3bnRf5[0]);pmf_free(
...
real_T*basis1,const size_t*bin1,const real_T*basis2,const size_t*bin2,const
real_T*basis3,const size_t*bin3,const real_T*basis4,const size_t*bin4,const
real_T*fx,const size_t*n1,const size_t*n2,const size_t*n3,const size_t*n4,
const real_T*work1,const size_t*work2,const size_t*numels){size_t
ex__wN5g_p_uwdVVLfRtx9szc;for(ex__wN5g_p_uwdVVLfRtx9szc=0;
ex__wN5g_p_uwdVVLfRtx9szc<*numels;ex__wN5g_p_uwdVVLfRtx9szc++){
ex_kTwu6FGHauCWW1q7bqdYqX(fi+ex__wN5g_p_uwdVVLfRtx9szc,basis1+4*
ex__wN5g_p_uwdVVLfRtx9szc,*(bin1+ex__wN5g_p_uwdVVLfRtx9szc),basis2+4*
ex__wN5g_p_uwdVVLfRtx9szc,*(bin2+ex__wN5g_p_uwdVVLfRtx9szc),basis3+4*
ex__wN5g_p_uwdVVLfRtx9szc,*(bin3+ex__wN5g_p_uwdVVLfRtx9szc),basis4+4*
ex__wN5g_p_uwdVVLfRtx9szc,*(bin4+ex__wN5g_p_uwdVVLfRtx9szc),fx,*n1,*n2,*n3,*n4
,0,work1,work2);}}void tlu2_4d_akima_nearest_value_custom_function_(void*out,
const void*in){const real_T*basis1=(const real_T*)((const void*const*)in)[0];
const size_t*bin1=(const size_t*)((const void*const*)in)[1];const real_T*
basis2=(const real_T*)((const void*const*)in)[2];const size_t*bin2=(const
size_t*)((const void*const*)in)[3];const real_T*basis3=(const real_T*)((const
void*const*)in)[4];const size_t*bin3=(const size_t*)((const void*const*)in)[5]
;const real_T*basis4=(const real_T*)((const void*const*)in)[6];const size_t*
bin4=(const size_t*)((const void*const*)in)[7];const real_T*fx=(const real_T*)
((const void*const*)in)[8];const size_t*n1=(const size_t*)((const void*const*)
in)[9];const size_t*n2=(const size_t*)((const void*const*)in)[10];const size_t
*n3=(const size_t*)((const void*const*)in)[11];const size_t*n4=(const size_t*)
((const void*const*)in)[12];const real_T*work1=(const real_T*)((const void*
const*)in)[13];const size_t*work2=(const size_t*)((const void*const*)in)[14];
const size_t*numels=(const size_t*)((const void*const*)in)[15];real_T*fi=(
real_T*)out;tlu2_4d_akima_nearest_value(fi,basis1,bin1,basis2,bin2,basis3,bin3
,basis4,bin4,fx,n1,n2,n3,n4,work1,work2,numels);}void
tlu2_4d_akima_linear_value(real_T*fi,const real_T*basis1,const size_t*bin1,
const real_T*basis2,const size_t*bin2,const real_T*basis3,const size_t*bin3,
const real_T*basis4,const size_t*bin4,const real_T*fx,const size_t*n1,const
size_t*n2,const size_t*n3,const size_t*n4,const real_T*work1,const size_t*
work2,const size_t*numels){size_t ex__wN5g_p_uwdVVLfRtx9szc;for(
ex__wN5g_p_uwdVVLfRtx9szc=0;ex__wN5g_p_uwdVVLfRtx9szc<*numels;
ex__wN5g_p_uwdVVLfRtx9szc++){ex_kTwu6FGHauCWW1q7bqdYqX(fi+
ex__wN5g_p_uwdVVLfRtx9szc,basis1+4*ex__wN5g_p_uwdVVLfRtx9szc,*(bin1+
ex__wN5g_p_uwdVVLfRtx9szc),basis2+4*ex__wN5g_p_uwdVVLfRtx9szc,*(bin2+
ex__wN5g_p_uwdVVLfRtx9szc),basis3+4*ex__wN5g_p_uwdVVLfRtx9szc,*(bin3+
ex__wN5g_p_uwdVVLfRtx9szc),basis4+4*ex__wN5g_p_uwdVVLfRtx9szc,*(bin4+
ex__wN5g_p_uwdVVLfRtx9szc),fx,*n1,*n2,*n3,*n4,1,work1,work2);}}void
tlu2_4d_akima_linear_value_custom_function_(void*out,const void*in){const
real_T*basis1=(const real_T*)((const void*const*)in)[0];const size_t*bin1=(
const size_t*)((const void*const*)in)[1];const real_T*basis2=(const real_T*)((
const void*const*)in)[2];const size_t*bin2=(const size_t*)((const void*const*)
in)[3];const real_T*basis3=(const real_T*)((const void*const*)in)[4];const
size_t*bin3=(const size_t*)((const void*const*)in)[5];const real_T*basis4=(
const real_T*)((const void*const*)in)[6];const size_t*bin4=(const size_t*)((
const void*const*)in)[7];const real_T*fx=(const real_T*)((const void*const*)in
)[8];const size_t*n1=(const size_t*)((const void*const*)in)[9];const size_t*n2
=(const size_t*)((const void*const*)in)[10];const size_t*n3=(const size_t*)((
const void*const*)in)[11];const size_t*n4=(const size_t*)((const void*const*)
in)[12];const real_T*work1=(const real_T*)((const void*const*)in)[13];const
size_t*work2=(const size_t*)((const void*const*)in)[14];const size_t*numels=(
const size_t*)((const void*const*)in)[15];real_T*fi=(real_T*)out;
tlu2_4d_akima_linear_value(fi,basis1,bin1,basis2,bin2,basis3,bin3,basis4,bin4,
fx,n1,n2,n3,n4,work1,work2,numels);}static void ex_kTwu6FGHauCWW1q7bqdYqX(
real_T*fi,const real_T*ex_Vl61InPOzylYgiebES6ELs,const size_t bin1,const real_T
*ex_kB9XB9hzwwW7Vu4shvxxya,const size_t bin2,const real_T*
ex__laKwhSBF10XcXh2QbGZxl,const size_t bin3,const real_T*
ex__Q9yozQvPAKfXeWWDJqbpI,const size_t bin4,const real_T*fx1,const size_t n1,
const size_t n2,const size_t n3,const size_t n4,const size_t
ex_F_tm5fod4xxuguhS49BSQm,const real_T*work1,const size_t*work2){const size_t n
...
real_T*basis[4];size_t ex__I2IEgdElv80cD1Kv0uRpM[1];size_t
ex__bBTzednxRh0WT2E2HNmTx[1];size_t ex_VTU42MKlyy4vayjUvcNV_7[1];size_t
ex_kyiLb15hdytNaHHfMTtx2o[1];size_t*ex_Vic4f_t1_8lMdPxTHOuua8[4];real_T*
ex_V1PpSt9JShK3bL1Bw6asF1;size_t*ex_VVfVnPxpzepMZXSq9ZSsjY;real_T*
...
ex_VQMmQUcKA3_3ei3Owj7WVV(ex__Q9yozQvPAKfXeWWDJqbpI);ex__I2IEgdElv80cD1Kv0uRpM
...
work1);ex_VVfVnPxpzepMZXSq9ZSsjY=ex__ge8CPdYTqKVfmxfN0MdXT(work2);
...
ex_VorZCi5_B5tOa9oe3bnRf5[0],basis,&ex_V1PpSt9JShK3bL1Bw6asF1[0],&
