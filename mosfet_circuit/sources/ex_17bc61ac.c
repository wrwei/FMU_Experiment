...
size_t ex_F_tm5fod4xxuguhS49BSQm);size_t ex_VzC4wVDNwRO2VyQZ1TOBFP(real_T*H,
real_T*G,const real_T*x,const size_t n,const real_T t,const boolean_T
ex_V0dauSHHy5d6_D42s3Aeag);void tlu2_linear_linear_prelookup(real_T*H,real_T*G
,size_t*bin,const real_T*x,const real_T*t,const size_t*n,const size_t*numels){
size_t ex__wN5g_p_uwdVVLfRtx9szc;for(ex__wN5g_p_uwdVVLfRtx9szc=0;
ex__wN5g_p_uwdVVLfRtx9szc<*numels;ex__wN5g_p_uwdVVLfRtx9szc++){*(bin+
ex__wN5g_p_uwdVVLfRtx9szc)=ex_VzC4wVDNwRO2VyQZ1TOBFP(H+2*
ex__wN5g_p_uwdVVLfRtx9szc,G+2*ex__wN5g_p_uwdVVLfRtx9szc,x,*n,*(t+
ex__wN5g_p_uwdVVLfRtx9szc),true);}}void
...
*)((const void*const*)in)[1];const size_t*n=(const size_t*)((const void*const*
)in)[2];const size_t*numels=(const size_t*)((const void*const*)in)[3];real_T*H
=(real_T*)((void**)out)[0];real_T*G=(real_T*)((void**)out)[1];size_t*bin=(
size_t*)((void**)out)[2];tlu2_linear_linear_prelookup(H,G,bin,x,t,n,numels);}
void tlu2_linear_nearest_prelookup(real_T*H,real_T*G,size_t*bin,const real_T*x
,const real_T*t,const size_t*n,const size_t*numels){size_t
ex__wN5g_p_uwdVVLfRtx9szc;for(ex__wN5g_p_uwdVVLfRtx9szc=0;
ex__wN5g_p_uwdVVLfRtx9szc<*numels;ex__wN5g_p_uwdVVLfRtx9szc++){*(bin+
ex__wN5g_p_uwdVVLfRtx9szc)=ex_VzC4wVDNwRO2VyQZ1TOBFP(H+2*
ex__wN5g_p_uwdVVLfRtx9szc,G+2*ex__wN5g_p_uwdVVLfRtx9szc,x,*n,*(t+
ex__wN5g_p_uwdVVLfRtx9szc),false);}}void
tlu2_linear_nearest_prelookup_custom_function_(void*out,const void*in){const
real_T*x=(const real_T*)((const void*const*)in)[0];const real_T*t=(const real_T
*)((const void*const*)in)[1];const size_t*n=(const size_t*)((const void*const*
)in)[2];const size_t*numels=(const size_t*)((const void*const*)in)[3];real_T*H
=(real_T*)((void**)out)[0];real_T*G=(real_T*)((void**)out)[1];size_t*bin=(
size_t*)((void**)out)[2];tlu2_linear_nearest_prelookup(H,G,bin,x,t,n,numels);}
void tlu2_akima_linear_prelookup(real_T*basis,size_t*bin,const size_t*
...
ex__wN5g_p_uwdVVLfRtx9szc<*numels;ex__wN5g_p_uwdVVLfRtx9szc++){*(bin+
ex__wN5g_p_uwdVVLfRtx9szc)=ex_F0HBEJ7qD9OkfDK6FdP9lf(basis+4*
ex__wN5g_p_uwdVVLfRtx9szc,*derivativeOrder,x,*n,*(t+ex__wN5g_p_uwdVVLfRtx9szc)
,1);}}void tlu2_akima_linear_prelookup_custom_function_(void*out,const void*in
){const size_t*derivativeOrder=(const size_t*)((const void*const*)in)[0];const
real_T*x=(const real_T*)((const void*const*)in)[1];const real_T*t=(const real_T
*)((const void*const*)in)[2];const size_t*n=(const size_t*)((const void*const*
)in)[3];const size_t*numels=(const size_t*)((const void*const*)in)[4];real_T*
basis=(real_T*)((void**)out)[0];size_t*bin=(size_t*)((void**)out)[1];
tlu2_akima_linear_prelookup(basis,bin,derivativeOrder,x,t,n,numels);}void
...
ex__wN5g_p_uwdVVLfRtx9szc)=ex_F0HBEJ7qD9OkfDK6FdP9lf(basis+4*
ex__wN5g_p_uwdVVLfRtx9szc,*derivativeOrder,x,*n,*(t+ex__wN5g_p_uwdVVLfRtx9szc)
,0);}}void tlu2_akima_nearest_prelookup_custom_function_(void*out,const void*
in){const size_t*derivativeOrder=(const size_t*)((const void*const*)in)[0];
const real_T*x=(const real_T*)((const void*const*)in)[1];const real_T*t=(const
real_T*)((const void*const*)in)[2];const size_t*n=(const size_t*)((const void*
const*)in)[3];const size_t*numels=(const size_t*)((const void*const*)in)[4];
real_T*basis=(real_T*)((void**)out)[0];size_t*bin=(size_t*)((void**)out)[1];
tlu2_akima_nearest_prelookup(basis,bin,derivativeOrder,x,t,n,numels);}
