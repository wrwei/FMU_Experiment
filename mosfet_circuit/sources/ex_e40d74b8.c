...
ex__aHtP2BVh3GTdL9OJAJPQn(real_T*fi,const real_T*H1,const size_t bin1,const
...
tlu2_3d_linear_nearest_process(real_T*x1,real_T*x2,real_T*x3,real_T*f,const
...
real_T*f=(real_T*)((void**)out)[3];tlu2_3d_linear_nearest_process(x1,x2,x3,f,
x1s,x2s,x3s,fs,n1,n2,n3);}void tlu2_3d_linear_linear_process(real_T*x1,real_T*
x2,real_T*x3,real_T*f,const real_T*x1s,const real_T*x2s,const real_T*x3s,const
real_T*fs,const size_t*n1,const size_t*n2,const size_t*n3){
ex_ksYC8da6QGWSjmLmtHDYLu(x1,x2,x3,f,x1s,x2s,x3s,fs,*n1,*n2,*n3);}void
tlu2_3d_linear_linear_process_custom_function_(void*out,const void*in){const
...
];tlu2_3d_linear_linear_process(x1,x2,x3,f,x1s,x2s,x3s,fs,n1,n2,n3);}static
void ex_ksYC8da6QGWSjmLmtHDYLu(real_T*x1,real_T*x2,real_T*x3,real_T*f,const
real_T*x1s,const real_T*x2s,const real_T*x3s,const real_T*fs,const size_t n1,
const size_t n2,const size_t n3){const size_t n=n1*n2*n3;memcpy(x1,x1s,n1*
...
,n2,n3);}void tlu2_3d_linear_nearest_value(real_T*fi,const real_T*H1,const
size_t*bin1,const real_T*H2,const size_t*bin2,const real_T*H3,const size_t*
bin3,const real_T*f,const size_t*n1,const size_t*n2,const size_t*n3,const
...
false);}}void tlu2_3d_linear_nearest_value_custom_function_(void*out,const void
*in){const real_T*H1=(const real_T*)((const void*const*)in)[0];const size_t*
bin1=(const size_t*)((const void*const*)in)[1];const real_T*H2=(const real_T*)
((const void*const*)in)[2];const size_t*bin2=(const size_t*)((const void*const
*)in)[3];const real_T*H3=(const real_T*)((const void*const*)in)[4];const size_t
*bin3=(const size_t*)((const void*const*)in)[5];const real_T*f=(const real_T*)
((const void*const*)in)[6];const size_t*n1=(const size_t*)((const void*const*)
in)[7];const size_t*n2=(const size_t*)((const void*const*)in)[8];const size_t*
n3=(const size_t*)((const void*const*)in)[9];const size_t*numels=(const size_t
*)((const void*const*)in)[10];real_T*fi=(real_T*)out;
tlu2_3d_linear_nearest_value(fi,H1,bin1,H2,bin2,H3,bin3,f,n1,n2,n3,numels);}
void tlu2_3d_linear_linear_value(real_T*fi,const real_T*H1,const size_t*bin1,
const real_T*H2,const size_t*bin2,const real_T*H3,const size_t*bin3,const
real_T*f,const size_t*n1,const size_t*n2,const size_t*n3,const size_t*numels){
...
const real_T*H1=(const real_T*)((const void*const*)in)[0];const size_t*bin1=(
const size_t*)((const void*const*)in)[1];const real_T*H2=(const real_T*)((
const void*const*)in)[2];const size_t*bin2=(const size_t*)((const void*const*)
in)[3];const real_T*H3=(const real_T*)((const void*const*)in)[4];const size_t*
bin3=(const size_t*)((const void*const*)in)[5];const real_T*f=(const real_T*)(
(const void*const*)in)[6];const size_t*n1=(const size_t*)((const void*const*)
...
n3=(const size_t*)((const void*const*)in)[9];const size_t*numels=(const size_t
*)((const void*const*)in)[10];real_T*fi=(real_T*)out;
tlu2_3d_linear_linear_value(fi,H1,bin1,H2,bin2,H3,bin3,f,n1,n2,n3,numels);}
static void ex__aHtP2BVh3GTdL9OJAJPQn(real_T*fi,const real_T*H1,const size_t
bin1,const real_T*H2,const size_t bin2,const real_T*H3,const size_t bin3,const
real_T*f,const size_t n1,const size_t n2,const size_t n3,const boolean_T
